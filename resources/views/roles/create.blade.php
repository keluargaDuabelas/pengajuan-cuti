                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Create role permissions</h5>
                    ...
                    @csrf
                        ...
                        <input class="form-check-input @error('permissions') is-invalid @enderror" multiple aria-label="Permissions" id="permissions" name="permissions[]"  type="checkbox" value="{{ $permission->id }}" {{ in_array($permission->id, old('permissions') ?? []) ? 'checked' : '' }} />
                      ...
                      @empty
                        ...
                        <button type="submit" class="btn btn-primary" value="Add Role">Submit</button>
                      </form>
                    </div>
                  </div>
                </div>
